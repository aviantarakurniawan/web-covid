      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'backend/wilayah' ?>"><i class="fa fa-globe"></i> Wilayah</a></li>
          </ul>
        </li>
...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Tambah Wilayah</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/wilayah/tambah_wilayah'?>" enctype="multipart/form-data">
        <div class="modal-body">

            <div class="form-group">
                <label class="control-label col-xs-3" >RW</label>
                <div class="col-xs-8">
                    <input name="rw" class="form-control" type="number" placeholder="RW" required="required">
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-xs-3" >Total Penduduk</label>
                <div class="col-xs-8">
                    <input name="penduduk" class="form-control" type="number" placeholder="Total Penduduk" required="required">
                </div>
            </div>
...
<div class="modal fade" id="ModalUpdate<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3 class="modal-title" id="myModalLabel">Update Wilayah</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/wilayah/edit_wilayah'?>" enctype="multipart/form-data">
        <div class="modal-body">
                   
            <div class="form-group">
                <label class="control-label col-xs-3" >RW</label>
                <div class="col-xs-8">
                    <input name="rw" value="<?php echo $rw; ?>" class="form-control" type="number" placeholder="RW" required="required">
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label col-xs-3" >Total Penduduk</label>
                <div class="col-xs-8">
                    <input name="penduduk" value="<?php echo $penduduk; ?>" class="form-control" type="number" placeholder="Total Penduduk" required="required">
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Wilayah</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'backend/wilayah/hapus_wilayah'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                          <p>Apakah Anda yakin mau menghapus wilayah ini?</p>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Wilayah Berhasil disimpan ke database.",
    ...
    <?php elseif($this->session->flashdata('msg')=='failed'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Failed',
                    text: "Wilayah Gagal ditambahkah data sudah ada.",
                    showHideTransition: 'slide',
                    icon: 'danger',
                    hideAfter: 2800,
                    position: 'bottom-right',
